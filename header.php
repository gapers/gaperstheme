                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 align-left">
                            ...
                            <h1 class="header-title wow fadeIn <?php echo get_theme_mod( 'relia_logo_or_title', 'logo' ) == 'title' ? '' : 'relia-hidden' ; ?>">
                                <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php bloginfo( 'name' ); ?></a>
                            </h1>

                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( get_theme_mod( 'relia_header_logo', get_template_directory_uri() . '/inc/images/gapers-logo.png' ) ); ?>" alt="<?php bloginfo( 'name' ); ?>"
                                style="height: <?php echo esc_attr( get_theme_mod( 'relia_logo_size', 50 ) ); ?>px; width: auto;"
                                class="header-logo wow fadeIn <?php echo get_theme_mod( 'relia_logo_or_title', 'logo' ) == 'logo' ? '' : 'relia-hidden' ; ?>"></a>
